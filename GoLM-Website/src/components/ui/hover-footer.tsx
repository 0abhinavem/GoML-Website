    ...
    >
      <defs>
        ...
        >
          {hovered && (
            <>
              {/* Using deep muted red variations */}
              <stop offset="0%" stopColor="#7A1F1F" />
              <stop offset="25%" stopColor="#8B0000" />
              <stop offset="50%" stopColor="#6B1A1A" />
              <stop offset="75%" stopColor="#5A1212" />
      ...
      <motion.text
        ...
        strokeWidth="1.5"
        fontSize="105"
        className="fill-transparent stroke-[#7A1F1F] font-[helvetica] font-bold dark:stroke-[#7A1F1F99]"
...
export const FooterBackgroundGradient = () => {
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(125% 125% at 50% 10%, #00000000 50%, #7A1F1F15 100%)",
      }}
    />
  );
};
